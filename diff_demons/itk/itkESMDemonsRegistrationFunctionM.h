...
Module:    $RCSfile: itkESMDemonsRegistrationFunctionM.h,v $
Language:  C++
...
#ifndef __itkESMDemonsRegistrationFunctionM_h
#define __itkESMDemonsRegistrationFunctionM_h
...
namespace itk {
/**
 * \class ESMDemonsRegistrationFunctionM
 *
...
class ITK_EXPORT ESMDemonsRegistrationFunctionM :
      public PDEDeformableRegistrationFunctionM< TFixedImage,TMovingImage, 
																							TDeformationField,TMask>
{
public:
  /** Standard class typedefs. */
  typedef ESMDemonsRegistrationFunctionM               Self;
  typedef PDEDeformableRegistrationFunctionM<
  ...
  itkTypeMacro( ESMDemonsRegistrationFunctionM,
  ...
  typedef typename WarperType::Pointer              MaskWarperPointer;
  ...
  void SetMovingImageMaskInterpolator( MaskInterpolatorType * ptr )
    { m_MovingImageMaskInterpolator = ptr; m_MovingImageMaskWarper->SetInterpolator( ptr ); }
...
private:
  ESMDemonsRegistrationFunctionM(const Self&); //purposely not implemented
  ...
  /** Filter to warp moving image mask for fast gradient computation. */
  MaskWarperPointer               m_MovingImageMaskWarper;
...
#include "itkESMDemonsRegistrationFunctionM.txx"
#endif
