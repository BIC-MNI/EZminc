...
template <class TFixedImage, class TMovingImage, class TField,class TMask>
typename SymmetricLogDomainDemonsRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
...
// Checks whether the DifferenceFunction is of type DemonsRegistrationFunction.
template <class TFixedImage, class TMovingImage, class TField,class TMask>
const typename SymmetricLogDomainDemonsRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
::DemonsRegistrationFunctionType*
SymmetricLogDomainDemonsRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
...
::InitializeIteration()
{
    ...
    b->SetFixedImageMask( this->GetMovingImageMask() );
    b->SetMovingImageMask( this->GetFixedImageMask() );
...
::Initialize()
{
    //std::cout<<"SymmetricLogDomainDemonsRegistrationFilterM::Initialize"<<std::endl;
...
// Get gradient type
template <class TFixedImage, class TMovingImage, class TField,class TMask>
typename SymmetricLogDomainDemonsRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>::GradientType
SymmetricLogDomainDemonsRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
...
{
    //std::cout<<"SymmetricLogDomainDemonsRegistrationFilterM::ApplyUpdate"<<std::endl;
    const DemonsRegistrationFunctionType *drfpf = this->GetForwardRegistrationFunctionType();
    const DemonsRegistrationFunctionType *drfpb = this->GetBackwardRegistrationFunctionType();
