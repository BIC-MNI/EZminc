...
/**
 * \class LogDomainDeformableRegistrationFilterM
 ...
 *
 * LogDomainDeformableRegistrationFilterM is a base case for filter implementing
...
class ITK_EXPORT LogDomainDeformableRegistrationFilterM : 
    public DenseFiniteDifferenceImageFilter<TField,TField>
{
public:
  /** Standard class typedefs. */
  typedef LogDomainDeformableRegistrationFilterM    Self;
  ...
  itkTypeMacro( LogDomainDeformableRegistrationFilterM, 
...
private:
  LogDomainDeformableRegistrationFilterM(const Self&); //purposely not implemented
