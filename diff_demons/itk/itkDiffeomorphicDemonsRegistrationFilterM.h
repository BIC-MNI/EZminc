/*=========================================================================
  ...
  Module:    $RCSfile: itkDiffeomorphicDemonsRegistrationFilterM.h,v $
  Language:  C++
...
#ifndef __itkDiffeomorphicDemonsRegistrationFilterM_h
#define __itkDiffeomorphicDemonsRegistrationFilterM_h
...
/** \class DiffeomorphicDemonsRegistrationFilterM
 ...
 * Proc. of MICCAI 2007.
 *
 * DiffeomorphicDemonsRegistrationFilterM implements the demons deformable algorithm that 
...
class ITK_EXPORT DiffeomorphicDemonsRegistrationFilterM : 
    public PDEDeformableRegistrationFilterM< TFixedImage, TMovingImage,
                                            TDeformationField,TMask>
{
public:
  /** Standard class typedefs. */
  typedef DiffeomorphicDemonsRegistrationFilterM       Self;
  ...
  itkTypeMacro( DiffeomorphicDemonsRegistrationFilterM, 
...
private:
  DiffeomorphicDemonsRegistrationFilterM(const Self&); //purposely not implemented
...
#include "itkDiffeomorphicDemonsRegistrationFilterM.txx"
#endif
