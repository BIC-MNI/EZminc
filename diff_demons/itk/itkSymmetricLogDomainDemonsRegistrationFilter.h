 ...
 */
template<class TFixedImage, class TMovingImage, class TField, class TMask=TFixedImage>
class ITK_EXPORT SymmetricLogDomainDemonsRegistrationFilterM : 
   public LogDomainDeformableRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
{
public:
  /** Standard class typedefs. */
  typedef SymmetricLogDomainDemonsRegistrationFilterM    Self;
  typedef LogDomainDeformableRegistrationFilterM<TFixedImage,TMovingImage,TField>   Superclass;
  ...
  itkTypeMacro( SymmetricLogDomainDemonsRegistrationFilterM,LogDomainDeformableRegistrationFilterM );
  ...
  typedef ESMDemonsRegistrationFunctionM<FixedImageType,
    MovingImageType, DeformationFieldType,TMask>                    DemonsRegistrationFunctionType;
...
protected:
  SymmetricLogDomainDemonsRegistrationFilterM();
  ~SymmetricLogDomainDemonsRegistrationFilterM() {}
...
private:
  SymmetricLogDomainDemonsRegistrationFilterM(const Self&); //purposely not implemented
