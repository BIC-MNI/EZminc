 ...
 *
 * At each resolution level a LogDomainDeformableRegistrationFilterM is used
 ...
 * scalars.
 *
 * The internal LogDomainDeformableRegistrationFilterM can be set using
 * SetRegistrationFilter. By default a LogDomainDemonsRegistrationFilterM is used.
 *
 ...
 *
 * \sa LogDomainDeformableRegistrationFilterM
 * \sa LogDomainDemonsRegistrationFilterM
 ...
 */
template <class TFixedImage, class TMovingImage, class TField, class TMask,class  TRealType = float>
class ITK_EXPORT MultiResolutionLogDomainDeformableRegistrationM :
            public ImageToImageFilter <TField, TField>
{
public:
    /** Standard class typedefs */
    typedef MultiResolutionLogDomainDeformableRegistrationM Self;
    ...
    itkTypeMacro( MultiResolutionLogDomainDeformableRegistrationM,
                  ImageToImageFilter );
    ...
    typedef LogDomainDeformableRegistrationFilterM<FloatImageType, FloatImageType, VelocityFieldType,TMask >
    RegistrationType;
		
    typedef typename RegistrationType::Pointer RegistrationPointer;

    /** The default registration type. */
    typedef LogDomainDemonsRegistrationFilterM<
    FloatImageType, FloatImageType, VelocityFieldType, TMask > DefaultRegistrationType;
...
private:
    MultiResolutionLogDomainDeformableRegistrationM(const Self&); //purposely not implemented
