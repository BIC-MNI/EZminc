...
class LogDomainDemonsRegistrationFilterM : 
   public LogDomainDeformableRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>
{
public:
  /** Standard class typedefs. */
  typedef LogDomainDemonsRegistrationFilterM             Self;
  typedef LogDomainDeformableRegistrationFilterM<TFixedImage,TMovingImage,TField,TMask>   Superclass;
  ...
  itkTypeMacro( LogDomainDemonsRegistrationFilterM,LogDomainDeformableRegistrationFilterM );
...
private:
  LogDomainDemonsRegistrationFilterM(const Self&); //purposely not implemented
