...
struct arguments
{
  ...
  friend std::ostream& operator<< ( std::ostream& o, const arguments& args )
  {
    ...
    return o
           ...
           << "  Output jacobian file: " << args.outputJacobianFile << std::endl
...
void parseOpts ( int argc, char **argv, struct arguments & args )
{
  ...
  command.AddOptionField ( "OutputFieldFile", "filename", MetaCommand::STRING, false );
...
class CommandIterationUpdate : public itk::Command
{
  public:
    ...
    typedef itk::DiffeomorphicDemonsRegistrationFilterM <
    InternalImageType,
    InternalImageType,
    DeformationFieldType,
    InternalImageType >                                  DiffeomorphicDemonsRegistrationFilterType;

    typedef itk::FastSymmetricForcesDemonsRegistrationFilterM <
    InternalImageType,
    InternalImageType,
    DeformationFieldType,
    InternalImageType >                                  FastSymmetricForcesDemonsRegistrationFilterType;

    typedef itk::MultiResolutionPDEDeformableRegistrationM <
    InternalImageType, InternalImageType,
    DeformationFieldType, InternalImageType, TPixel >     MultiResRegistrationFilterType;
...
void DemonsRegistrationFunction ( arguments args )
{
  ...
  {//for mem allocations
    ...
    typedef typename itk::PDEDeformableRegistrationFilterM
    < ImageType, ImageType, DeformationFieldType, MaskType>   BaseRegistrationFilterType;
    ...
    switch ( args.updateRule )
    {
      case 0:
      {
        ...
        typedef typename itk::DiffeomorphicDemonsRegistrationFilterM
        < ImageType, ImageType, DeformationFieldType, MaskType>
      ...
      case 1:
      {
        ...
        typedef typename itk::FastSymmetricForcesDemonsRegistrationFilterM
        < ImageType, ImageType, DeformationFieldType, MaskType>
        ActualRegistrationFilterType;
        typedef typename ActualRegistrationFilterType::GradientType GradientType;
    ...
    typedef typename itk::MultiResolutionPDEDeformableRegistrationM <
    ImageType, ImageType, DeformationFieldType, MaskType, PixelType >   MultiResRegistrationFilterType;
  ...
  {
    std::string output_def_field = args.outputFieldFile;
    std::string out_grid_base_name;
    
    if ( parse_xfm_file_name(args.outputFieldFile,output_def_field,out_grid_base_name ))
    {

      std::ofstream out_xfm ( args.outputFieldFile.c_str() );
